...
import DeleteIcon from '../../../../assets/svg/settings/delete';
import Button from '../../../../constants/Button';
import { useDispatch } from 'react-redux';
import { logout } from '../../../../features/slice/userSlice';
import { useNavigation } from '@react-navigation/native';

const DeleteAlert = ({ setPage }: { setPage: any }) => {
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.header}>
                        <View>
                            <Text style={styles.headerText}>Delete This Account?</Text>
                        </View>
                    ...
                    <View style={styles.buttonContainer}>
                        <Button containerStyle={styles.buttonNo} onPress={() => setPage("delete")} textStyle={styles.buttonText} title='No' />
