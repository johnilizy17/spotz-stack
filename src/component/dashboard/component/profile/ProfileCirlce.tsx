    ...
    return (
        <View style={styles.container}>
            ...
            <AnimatedCircularProgress
                size={58} // Diameter of the circle
                width={5} // Thickness of the circular bar
...
export default ProfileSettingCirlce;
