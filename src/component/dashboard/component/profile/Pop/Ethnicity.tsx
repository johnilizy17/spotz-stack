...
import EthnicityPop from './EthnicityPop';

const Ethnicity = ({ setProfilePop, profilePop }: { setProfilePop: any, profilePop: string }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <EthnicityPop setProfilePop={setProfilePop} />
      </Animated.View>
    </View>
  );
};
