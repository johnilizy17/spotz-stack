...
const TypePop = ({ setProfilePop, profilePop }: { setProfilePop: any, profilePop: string }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <TypeDetails setProfilePop={setProfilePop} />
      </Animated.View>
    </View>
  );
};
