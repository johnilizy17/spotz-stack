...
const HeightPop = ({ setProfilePop, profilePop }: { setProfilePop: any, profilePop: string }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <HeightDetails setProfilePop={setProfilePop} />
      </Animated.View>
    </View>
  );
};
