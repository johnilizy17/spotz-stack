...
const HeightSelectionScreen = () => {
    ...
    const [value, setValue] = useState({ "number":1, "id": "1", "feet": 1.0, "inches": 30.5 })
    const { onboardingData } = useSelector((a: { user: { onboardingData: any } }) => a.user)
    const dispatch = useDispatch()
    const HeightSubmit = () => {
        dispatch(onboarding({ ...onboardingData, height: {"feet": value.feet, "inches": value.inches} }))
        navigation.navigate("GenderMeet" as never)
    }
    ...
    return (
        <WithNoAuth>
            <View style={styles.container}>
                ...
                <Header title="2/8" textColor={COLORS.white} />
                ...
                <View style={styles.continueContainer}>
                    <Button title="Continue" onPress={HeightSubmit} containerStyle={styles.continueButton} textStyle={styles.continueButtonText} />
                    <TouchableOpacity onPress={HeightSubmit}>
